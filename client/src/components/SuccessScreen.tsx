...
export default function SuccessScreen({ username, id, onCopy, onShare, copying }: Props) {
  return (
    <motion.div
    ...
    >
      <div className="glass-card rounded-3xl p-8 text-center md:p-12">
        ...
        <h2 className="text-2xl font-extrabold text-white md:text-3xl">
          تم حجز مقعدك بنجاح <span aria-hidden>🎉</span>
        </h2>
        ...
        <div className="mx-auto mt-6 inline-flex items-center gap-2 rounded-xl border border-sky-400/25 bg-sky-500/10 px-5 py-2.5">
          <span className="text-muted-foreground text-sm">اسمك المحجوز:</span>
        ...
        <p className="mt-5 text-sm text-muted-foreground">
          احتفظ باسمك، سنكون بانتظارك عند الإطلاق.
        </p>

        {/* Registration ID */}
        <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 px-5 py-4">
          <p className="text-xs font-medium text-muted-foreground">رقم الحجز</p>
          <p className="font-display mt-1 text-xl font-bold tracking-[0.2em] text-white" dir="ltr">
            {id}
          </p>
          <div className="mt-4 flex flex-col items-stretch gap-2.5 sm:flex-row sm:justify-center">
            ...
            >
              ...
              {copying ? "تم النسخ" : "نسخ رقم الحجز"}
            </button>
            <button
              onClick={onShare}
