/**
 * الإعدادات المركزية لموقع ERKAN AI
 ...
 * يُعرض الرقم الأساسي (56,838) ويُضاف فوقه المسجلون الحقيقيون الجدد تلقائياً.
 */
export const BASE_REGISTERED_COUNT = 56838;

/** رابط الشعار الرسمي */
export const LOGO_URL = "/manus-storage/erkan-logo_3a933153.png";

/** النصوص الأساسية — سهلة التعديل لإضافة الإنجليزية لاحقاً */
export const SITE = {
  name: "ERKAN AI",
